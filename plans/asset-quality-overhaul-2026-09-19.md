...
아래는 발행 전 독립 검토 완료 시점의 기록입니다. 이후 메인 병합·Pages·프로필 적용 상태와 실행 링크는 [PR #25](https://github.com/t1seo/maeul-in-the-sky/pull/25)에 갱신합니다.
...
- [x] 기여 보상과 픽셀 파이프라인
- [x] 사용 흐름·통합·전후 자료
- [x] 전체 테스트·실제 브라우저·성능·독립 검토
- [x] 작업 브랜치 커밋·푸시·초안 PR #25
- [ ] 최종 CI 이후 메인 병합
