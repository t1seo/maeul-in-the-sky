...
- Keep tour day details readable with an opaque, lighting-aware background and hide the village introduction and statistics while the detail panel is open. Closing it restores the overview text; the corner map retains its translucent appearance.
